...
ActiveRecord::Schema[7.0].define(version: 2023_02_24_141557) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["soundcard_id"], name: "index_likes_on_soundcard_id"
    t.index ["user_id"], name: "index_likes_on_user_id"
  end

  create_table "soundcards", force: :cascade do |t|
    t.string "name"
  ...
  create_table "taggables", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["soundcard_id"], name: "index_taggables_on_soundcard_id"
